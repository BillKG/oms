    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-grey"><i class="mdi-editor-border-color"></i> Order Food</a>
            </li>
                <li class="no-padding">
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-grey"><i class="mdi-action-question-answer"></i> Tickets</a>
                            <div class="collapsible-body">
                                <ul>
            ...
            <li class="bold"><a href="details.php" class="waves-effect waves-grey"><i class="mdi-social-person"></i> Edit Details</a>
            </li>				
        </ul>
...
<button class="btn grey waves-effect waves-light right" type="submit" name="action" <?php if($_POST['payment_type'] == 'Wallet') {if ($balance-$total < 0) {echo 'disabled'; }}?>>Confirm Order
