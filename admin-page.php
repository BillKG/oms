        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                      <img src="images/materialize-logo.png" height="64px" alt="logo"><a href="index.php" class="brand-logo darken-1"></a></img>
                </div>
            </nav>
        </div>
        <!-- end header nav-->
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            <li class="user-details grey darken-2">
            <div class="row">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-grey"><i class="mdi-editor-border-color"></i>Items Catalogue</a>
            </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-grey"><i class="mdi-editor-insert-invitation"></i> Orders</a>
            ...
            <li class="bold"><a href="users.php" class="waves-effect waves-grey"><i class="mdi-social-person"></i> Users</a>
            </li>				
        </ul>
        <a href="#" data-activates="slide-out" class="sidebar-collapse btn-floating btn-medium waves-effect waves-light hide-on-large-only grey"><i class="mdi-navigation-menu"></i></a>
        </aside>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Items Catalogue</h5>
              </div>
            </div>
          </div>
        </div>
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/menu-router.php" novalidate="novalidate">
            <div class="row">
			  ...
			  <div class="input-field col s12">
                              <button class="btn grey waves-effect waves-light right" type="submit" name="action">Modify
...
<table>
			  ...
			  <div class="input-field col s12">
                              <button class="btn grey waves-effect waves-light right" type="submit" name="action">Add
                                <i class="mdi-content-send right"></i>
                              </button>
                            </div>
            </div>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2018 <a class="grey-text text-lighten-4" href="#" target="_blank">CS241</a> All rights reserved.</span>
        <span class="right"> CS241 Group 4 <a class="grey-text text-lighten-4" href="#">Students</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
    ...
    <!-- data-tables -->
    <script type="text/javascript" src="js/plugins/data-tables/js/dataTables.min.js"></script>
